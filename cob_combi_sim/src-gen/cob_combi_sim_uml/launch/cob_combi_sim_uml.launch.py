...
def generate_launch_description():
  ...
  teleop_twist_joy_node_config = os.path.join(
    get_package_share_directory('cob_combi_sim_uml'),
    'config',
  ...
  yolov8_node = Node(
    ...
    name="yolov8_node",
    remappings=[
      ("yolo_image_input", "torso_left_image_raw"),
  ...
  bt_lifecycle_node = Node(
    ...
    remappings=[
      ("callStdSrvTrigger", "set_Light_color"),
      ("sound_play", "sound_play"),
      ("callStdSrvTrigger", "set_Mimic"),
